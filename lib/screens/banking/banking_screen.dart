...
class BankingScreen extends StatelessWidget {
    ...
    return Column(
      ...
      children: [
        ...
        transactions.isEmpty
            ? const Center(child: Padding(padding: EdgeInsets.all(40), child: Text('NO TRANSACTIONS FOUND.', style: TextStyle(color: AppColors.muted, fontWeight: FontWeight.bold))))
            : Card(
                elevation: 0,
                        ...
                        children: [
                          Text(
                            ...
                            style: TextStyle(
                              fontWeight: FontWeight.w900,
                              fontSize: 16,
                              color: item.positive ? AppColors.green : AppColors.red,
                            ),
                          ),
  ...
  Widget _buildAccountCard(String name, String number, String balance, Color color) {
    return Card(
      elevation: 0,
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
              ...
              children: [
                Column(
                  ...
                  children: [
                    ...
                    Text(number, style: TextStyle(color: Colors.white.withValues(alpha: 0.6), fontWeight: FontWeight.bold)),
                  ],
                ),
                Container(
            ...
            const SizedBox(height: 32),
            const Text('AVAILABLE BALANCE', style: TextStyle(color: Colors.white70, fontSize: 11, fontWeight: FontWeight.w900)),
